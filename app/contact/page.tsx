...
const ContactUs = () => {
  return (
    <div className="bg-[#030617] flex flex-col justify-center pt-[var(--header-height)]">
      <Header className="fixed top-0 left-0 w-full z-50" />

      <div className="relative md:p-12 flex flex-col md:flex-row gap-10 md:gap-0 items-center md:mx-8 mt-70">
        <div className="w-full pt-8 pl-10 md:w-1/2 relative text-white font-[poppins]">
          <h2 className="text-2xl md:text-5xl font-[poppins] font-[600] mb-6">
            Contact Us<span className="text-[#0A66C2]">.</span>
          </h2>
          <div className="border-l-4 border-[#0A66C2] pl-6 py-4">
            ...
            <div className="mb-8">
              ...
              >
                <FaLocationDot className="text-red-700 mr-2"></FaLocationDot>See
                Location
              </a>
            </div>
        ...
        <div className="w-[80%] md:w-1/2 bg-[#FFFFFF0D] relative shadow-lg font-[poppins] font-[600]">
          <h3 className="w-fit absolute -top-5 left-0 right-0 mx-auto text-2xl font-bold text-white z-50">
            Contact Form
          </h3>
          <form className="p-6 m-4">
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="Name"
                required
                className="w-full p-2 border-b-2 border-[#FFFFFF80] divide-solid bg-transparent text-white focus:outline-none"
              />
            </div>
            <div className="mb-4">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-send-linear text-white p-2 rounded"
              >
                Send Message
              </button>
            </div>
